...
const COURSES = {
  ...
  COURSE_0_FOUNDATION: {
    ...
    lessons: [
      ...
      { id:"F02",  name:"จรรยาบรรณก่อนออกอากาศ",           dur:"25 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-06" },
      { id:"F03",  name:"ค้นหาตัวตนโฮสต์ของคุณ",           dur:"15 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-06" },
...
// ข้อมูลที่เคยบันทึกไว้ยังอ่านออก และ mapping QG ยังเป็นชุดเดิมทุกประการ
// จึงไม่มีคะแนนของผู้เรียนคนใดเปลี่ยนค่าจากการแก้ครั้งนี้
// ต้องตรงกับ src/lib/ppact.ts ของเว็บหลักเสมอ
// ============================================================
const RADAR_DIMS = [
  ...
  { key:"trust",         legacyKey:"brand", letter:"T", en:"Trust",         label:"Trust", labelTh:"ความไว้วางใจและจรรยาบรรณ",           qgs:["QG-06"] },
];
...
// ============================================================
// 📝  QUIZ BANK — 81 ข้อจริง (นับแล้ว: QG-01:16, QG-02:8, QG-03:9, QG-04:9,
// QG-05:16, QG-06:10, QG-07:13) — MCQ + True/False (auto-grade). แผนเดิมตั้งใจ
// ไว้ 116 ข้อ ยังเขียนไม่ครบ — ดู Bible ภาคผนวก Z2.1
// ============================================================
