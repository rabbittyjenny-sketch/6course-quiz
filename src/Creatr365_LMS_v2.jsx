...
const COURSES = {
  FR_MAGNET: {
    id: "FR_MAGNET", name: "MAGNET", badge: "แผนที่เริ่มต้น", type: "online",
    duration: "65 นาที",
    desc: "Live Commerce Blueprint — แผนที่ก่อนเข้าสู่ FOUNDATION (คอร์สฟรี)",
    pretestQGs: ["QG-01"], pretestCount: 5,
    lessons: [
      { id:"MG01", name:"Why Live Commerce Matters",              dur:"15 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-01" },
      { id:"MG02", name:"The Real Reason Live Succeeds or Fails",  dur:"10 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-01" },
      { id:"MG03", name:"Find Your Host Identity",                 dur:"10 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-10" },
      { id:"MG04", name:"First Live Blueprint",                    dur:"15 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-01" },
      { id:"MG05", name:"What Successful Lives Look Like",         dur:"5 นาที",  url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-01" },
      { id:"MG06", name:"Measure What Matters",                    dur:"10 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-05" },
    ],
    submission: { enabled: false, rubric:null, label:"" },
  },

  COURSE_0_FOUNDATION: {
    id: "COURSE_0_FOUNDATION", name: "FOUNDATION", badge: "STARTER", type: "online",
    duration: "4 ชั่วโมง 10 นาที",
    desc: "Course 0 — ไลฟ์ให้เป็น: อุปกรณ์ จรรยาบรรณ Hook ASBC และ KPI พื้นฐาน",
    pretestQGs: ["QG-01","QG-08"], pretestCount: 10,
    lessons: [
      { id:"F001", name:"ปัญหาที่แท้จริงของนักไลฟ์ไทย",   dur:"15 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-01" },
      { id:"F01",  name:"Live Commerce คืออะไร",             dur:"25 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-01" },
      { id:"F02",  name:"จรรยาบรรณก่อนออกอากาศ",           dur:"25 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-08" },
      { id:"F03",  name:"ค้นหาตัวตนโฮสต์ของคุณ",           dur:"15 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-09" },
      { id:"F04",  name:"สร้าง Hook ที่หยุดนิ้วผู้ชม",      dur:"60 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-01" },
      { id:"F05",  name:"เทคนิค ASBC",                       dur:"35 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-04" },
      { id:"F06",  name:"เตรียมตัวไลฟ์ครั้งแรก",             dur:"25 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-01" },
      { id:"F07",  name:"อ่านข้อมูลและเติบโต",               dur:"50 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-05" },
    ],
    submission: { enabled: true, rubric:"RUB-07", label:"ส่ง Hook เขียน 1 ชิ้น" },
  },

  COURSE_1_SIGNAL: {
    id: "COURSE_1_SIGNAL", name: "SIGNAL", badge: "CONVERSION HOST", type: "online",
    duration: "5 ชั่วโมง 30 นาที",
    desc: "Course 1 — ไลฟ์ให้ขายได้: PPACT — Trust, Presence, Communication, Psychology, Authority",
    pretestQGs: ["QG-01","QG-03","QG-04"], pretestCount: 15,
    lessons: [
      { id:"S00", name:"ภาพรวมและแรงจูงใจ",                          dur:"15 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-01" },
      { id:"S01", name:"รากฐานความเชื่อใจและจรรยาบรรณ",             dur:"45 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-08" },
      { id:"S02", name:"ทักษะร่างกาย เสียง และการปรากฏตัวหน้ากล้อง", dur:"60 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-03" },
      { id:"S03", name:"โครงสร้างบทพูด ASBC",                        dur:"60 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-04" },
      { id:"S04", name:"จิตวิทยาการโน้มน้าวใจขั้นสูง",               dur:"60 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-04" },
      { id:"S05", name:"ระบบหลังบ้านและการวัดผล",                    dur:"60 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-05" },
      { id:"S06", name:"มาตรฐานสากลและบทสรุป",                       dur:"30 นาที", url:"https://www.youtube.com/embed/QbuyU8EGMjU?si=npNmAGbOt4I0Almb", qg:"QG-06" },
    ],
    submission: { enabled: true, rubric:"RUB-01", label:"ส่ง Hook Video 30-45 วินาที" },
  },

  COURSE_2_STAGE: {
    id: "COURSE_2_STAGE", name: "STAGE", badge: "COMPETENT", type: "onsite",
    duration: "8 ชั่วโมง (1 วัน)",
    desc: "Communication Mastery Lab — ฝึก Vocal/Camera/Hook/Crisis หน้ากล้องจริง",
    pretestQGs: [], pretestCount: 0, // Trainer ประเมิน
    lessons: [
      { id:"ST1", name:"Foundation & Vocal Engine Lab",  dur:"09:00-10:30", url:null, qg:"QG-03", sessionCode:true },
      { id:"ST2", name:"Camera Presence",                dur:"10:30-11:30", url:null, qg:"QG-03", sessionCode:true },
      { id:"ST3", name:"Hook Factory",                   dur:"11:30-12:00 / 13:00-14:30", url:null, qg:"QG-01", sessionCode:true },
      { id:"ST4", name:"Narrative Performance",          dur:"14:30-15:30", url:null, qg:"QG-04", sessionCode:true },
      { id:"ST5", name:"Crisis Improv Lab",              dur:"15:30-16:30", url:null, qg:"QG-03", sessionCode:true },
      { id:"ST6", name:"KPI Test & Debrief",             dur:"16:30-17:00", url:null, qg:"QG-05", sessionCode:true },
    ],
    submission: { enabled: false, rubric:null, label:"" },
  },

  COURSE_3_BRAND_HOST: {
    id: "COURSE_3_BRAND_HOST", name: "BRAND HOST ARCHITECT", badge: "SCALE", type: "onsite",
    duration: "16 ชั่วโมง (2 วัน)",
    desc: "Identity Architecture, Production System, P&L Mastery และ Global Scaling",
    pretestQGs: ["QG-06","QG-07"], pretestCount: 10,
    lessons: [
      { id:"BH1", name:"5 Hidden Souls — Host Archetype DNA",              dur:"วัน 1 · 09:00-10:30", url:null, qg:"QG-06", sessionCode:true, day:1 },
      { id:"BH2", name:"Brand CI 4 มิติ สู่ความพรีเมียม",                  dur:"วัน 1 · 10:30-12:00", url:null, qg:"QG-06", sessionCode:true, day:1 },
      { id:"BH3", name:"Advanced Live Commerce Business Model",            dur:"วัน 1 · 13:00-15:00", url:null, qg:"QG-07", sessionCode:true, day:1 },
      { id:"BH4", name:"Legal Framework & Multi-Channel Contract",         dur:"วัน 1 · 15:00-17:00", url:null, qg:"QG-08", sessionCode:true, day:1 },
      { id:"BH5", name:"Multi-Camera Production Architecture",             dur:"วัน 2 · 09:00-10:30", url:null, qg:"QG-06", sessionCode:true, day:2 },
      { id:"BH6", name:"Team Production System & Hand Signals",            dur:"วัน 2 · 10:30-12:00", url:null, qg:"QG-06", sessionCode:true, day:2 },
...
const RADAR_DIMS = [
  ...
  { key:"brand",  label:"Brand/ธุรกิจ", qgs:["QG-06","QG-07","QG-08","QG-09","QG-10"] },
];
...
// LMS course id → Supabase courses.slug — must be the exact inverse of
// SLUG_TO_LMS in supabase/functions/get-enrollment/index.ts. A guessed
// lowercase/dash transform of the LMS id (e.g. "COURSE_0_FOUNDATION" →
// "course-0-foundation") does NOT match the real slug ("foundation"), which
// silently breaks score-saving — this explicit map replaces that guess.
const LMS_TO_SLUG = {
  FR_MAGNET:            "magnet",
...
// Inverse of LMS_TO_SLUG — used to resolve ?course=<slug> from the Dashboard
// deep-link back into a real LMS course id. Built from LMS_TO_SLUG itself so
// the two can never drift apart.
const SLUG_TO_LMS = Object.fromEntries(
...
function normalizeEnrollmentCourses(input) {
  ...
  return [...new Set(raw.map(v => {
    ...
    if (SLUG_TO_LMS[value]) return SLUG_TO_LMS[value];
    const upper = value.toUpperCase();
    if (COURSES[upper]) return upper;
    return value;
  }).filter(Boolean))];
}
  ...
  if (SUPABASE_ENROLL_URL) {
    try {
      ...
      if (res.ok) {
        ...
        courses = normalizeEnrollmentCourses(data.courses);
        if (data.display_name) displayName = data.display_name;
      }
    } catch(_) {}
  }

  // Apps Script is retained only as a compatibility fallback if Supabase does not answer.
  if (!supabaseAnswered) {
    const gsData = await apiGetStudent(id);
    const gsEnroll = await apiGetEnroll(id);
    courses = normalizeEnrollmentCourses(gsEnroll?.courses);
    registered = Boolean(gsEnroll?.courses?.length || gsData?.student_id || gsData?.id || gsData?.registered);
...
function LoginScreen({ onLogin }) {
  ...
  async function handle() {
    const id = kid.trim();
    if (!id) { setErr("กรุณากรอก Master Key"); return; }
    setLoading(true); setErr("");

    const { displayName, courses, registered } = await resolveEnrollment(id);
    if (!registered) {
      const params = new URLSearchParams(window.location.search);
      const returnTo = params.get("returnTo") || (document.referrer ? (() => { try { return new URL(document.referrer).origin + "/register?master_key=" + encodeURIComponent(id); } catch { return ""; } })() : "");
      if (returnTo) { window.location.href = returnTo; return; }
      setErr("ยังไม่มีบัญชีผู้เรียนที่เชื่อมกับ Master Key นี้");
      setLoading(false);
      return;
    }
    if (!courses.length) {
      setErr("บัญชีนี้ยังไม่มีคอร์สที่ได้รับสิทธิ์");
      setLoading(false);
      return;
    }
  ...
  return (
    <div style={{ ...S.wrap, maxWidth:440, paddingTop:60 }}>
      ...
      <div style={S.card}>
        ...
        <input style={S.input} placeholder="Master Key"
